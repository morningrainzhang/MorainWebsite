...
class EmailSerializer(serializers.Serializer):
    ...
    def validate_email(self, email):
        ...
        if EmailVerifyRecord.objects.filter(add_time__gt=one_mintes_ago, email=email).count():
            raise serializers.ValidationError("请求发送过于频繁，请间隔60秒后重试")
